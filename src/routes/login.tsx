...
function LoginPage() {
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-between bg-gradient-to-tr from-slate-100 via-slate-50 to-blue-50/30 dark:from-slate-900 dark:via-slate-950 dark:to-slate-900 p-6">
      ...
      <div className="mt-8 text-center text-xs font-semibold text-slate-400 dark:text-slate-500/80 flex flex-col items-center gap-1 select-none animate-in fade-in duration-700">
        <div className="flex items-center gap-1.5">
          <span>Developed by</span>
          <span className="font-extrabold text-slate-600 dark:text-slate-400 bg-slate-100 dark:bg-slate-800/80 px-2 py-0.5 rounded shadow-xs tracking-wider">
            Selio Solutions
          </span>
        </div>
      </div>
